...
#if defined(NDEBUG)
# error "Levitate cannot be compiled without assertions."
#endif
...
int nStakeMinConfirmations = 10080;
unsigned int nStakeMinAge = 168 * 60 * 60; // 168 hours
...
const string strMessageMagic = "Levitate Signed Message:\n";
